...
export const Test = () => {
    ...
    useEffect(() => {
        window.addEventListener('keypress', e => focusTest(e))
        ...
        return () => {
            window.removeEventListener('keypress', e => focusTest(e))
        }
    })
    ...
    return (
        <Context.Provider value={{
            checking, space, setSpace, setWrongWords, setCorrectWords, correctWords, wrongWords, totalPress
        }}>
            <div className="container test">
                ...
                <div className="tools">
                    <input type="text" id="inputSpace" value={word} disabled={disabled} onChange={hanleClicks} onKeyPress={handlePress}/>
